...
if __name__ == '__main__':
    ...
    parser.add_argument('dst_path',
                        default=None,
                        type=Path,
                        help='Directory path of hdf5 videos')
    parser.add_argument(
        'dataset',
        default='',
        type=str,
        help='Dataset name (kinetics | mit | ucf101 | hmdb51 | activitynet | msr-vtt)')
    ...
    if args.dataset in ['kinetics', 'mit', 'activitynet', 'msr-vtt']:
        ext = '.mp4'
    else:
        ext = '.avi'

    if args.dataset in ['activitynet', 'msr-vtt', 'msvd']:
